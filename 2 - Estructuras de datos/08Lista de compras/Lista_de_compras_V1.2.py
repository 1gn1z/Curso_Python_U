...
def agregar_articulo():     #Funcion que NO espera ningun parametro
    print()     # Print en blanco para dejar un poco de espacio.
    ...
    print("Articulo Agregado")          # Retroalimentacion al usuario.
    print()
...
def ver_articulos():        #Funcion que NO espera ningun parametro
    print()                 # Un espacio para que no se haga un amontonadero hechizo
    print("__________Articulos Agregados__________")    # Para que se vea mas chulo :3
    ...
    print() # Otro print en blanco para dejar mas espacio. FUERA DEL CICLO FOR!
