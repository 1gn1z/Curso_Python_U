...
# Remover Contactos	LISTO!
# Actualizar Contactos
# Ver un contacto	LISTO!
...
def remover_contacto():
  nombre = input("Nombre del contacto que deseas borrar: ")   # El usuario escribe el nombre del contacto a borrar alv
  del agenda_telefonica[nombre]                               # DEL para eliminar de la agenda el nombre especificado.
  print("----------Agenda Telefonica----------")
  print("Contacto borrado satisfactoriamente")
  print()
...
def ver_contacto():
  nombre = input("Nombre del contacto que quieres ver: ")
  print()
  print("----------Agenda Telefonica----------")
