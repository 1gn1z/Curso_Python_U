...
#    password = getpass.getpass('Pass!!!')# <<<--- Funcion para introducir la contraseña de forma segura (No se ve lo escrito)
     ...
     #   print('\nIncorrect password.\nPassword required to access diary\n')
      #  sys.exit(1)                     # <<<--- Salir del programa si la contraseña no es correcta
    create_n_connect()
    menu_loop()
